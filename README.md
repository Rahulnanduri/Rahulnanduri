...
My technical work currently centres on Python, data analysis, and automation. I am expanding that foundation toward C#, .NET, SQL, API design, and dependable operations tooling. The goal is straightforward: turn operational problems into clear, maintainable technical solutions.

## Current focus

- Applying data and automation to operational workflows and decisions
- Strengthening software-engineering fundamentals through C# and .NET
- Building toward API-backed tools for logistics and technical operations
